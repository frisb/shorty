...
var net     = require('net'),
    ...
    counter = require('./perfmon').counter,
    split = require('split'),
    smpp;
...
var serverConnection = function(socket, server, closeConnectionServerCallback, smppDefs) {
    ...
    self.init = function() {
        self.socket.setNoDelay(false);
        //OC
        self.socket.setEncoding('utf8');
        stream = self.socket.pipe(split());
        stream.on('data', self.socketDataHandler);
    ...
    self.socketDataHandler = function(buffer) {
        ...
        //OC
        if (buffer && buffer instanceof String) {
            counter.receive++;
            return;
        }
    ...
    self.deliverMessage = function(params, optional) {
        //OC
        counter.send++;
        self.socket.write('\n');
        return;
